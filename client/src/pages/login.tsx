...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="relative flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button variant="outline" type="button" className="bg-background/50" data-testid="button-google">
                  ...
                  <Button variant="outline" type="button" className="bg-background/50" data-testid="button-apple">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <a href="#" className="text-primary hover:underline font-medium" data-testid="link-sign-up">
              Sign up for free
            </a>
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Your data is protected with bank-grade encryption. We never store your credentials locally.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="relative z-10 border-t border-border/50 py-4 bg-background/80 backdrop-blur-xl">
